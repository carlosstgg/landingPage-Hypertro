  ...
  return (
    <section id="gamification" className="py-32 relative overflow-hidden bg-black">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        >
             <h2 className="text-secondary text-xl font-bold tracking-widest mb-2">RPG SYSTEM</h2>
             <h3 className="text-5xl md:text-7xl font-teko uppercase text-white mb-6 leading-[0.9]">
               Convierte el Dolor<br/> <span className="text-gray-500">en Prestigio</span>
             </h3>
             <p className="text-gray-400 text-lg mb-10 leading-relaxed font-inter">
               En HYPERTRO, cada sesión completa te otorga puntos de experiencia (XP). Desbloquea medallas, consigue rachas de fuego y asciende en la jerarquía militar. ¿Tienes lo necesario para alcanzar el rango de General?
             </p>
             ...
             <div className="space-y-4">
                 ...
                 <div className="flex justify-between text-xs uppercase tracking-widest text-gray-500 font-bold">
                     <span className="flex items-center gap-2"><div className="w-2 h-2 bg-gray-600 rounded-full"></div> Recluta</span>
                     <span className="flex items-center gap-2 text-primary"><div className="w-2 h-2 bg-primary rounded-full animate-pulse"></div> Veterano</span>
                     <span className="flex items-center gap-2 text-secondary"><div className="w-2 h-2 bg-secondary rounded-full"></div> Leyenda</span>
                 </div>
             </div>
        </motion.div>
        ...
        >
            ...
            <div className="relative z-10 bg-[#0A0A0A] border border-white/10 p-8 rounded-3xl transform rotate-3 hover:rotate-0 transition-transform duration-500 shadow-2xl">
                <div className="flex justify-between items-center mb-6">
                    <span className="text-gray-500 uppercase text-xs tracking-widest font-bold">Logro Desbloqueado</span>
                    <span className="text-xs text-gray-600">Ahora mismo</span>
                </div>
                <div className="flex gap-5 items-center">
                   ...
                   <div>
                       <h4 className="text-white font-bold text-xl font-teko tracking-wide">REY DE LA HIPERTROFIA</h4>
                       <p className="text-gray-400 text-sm">Alcanza 100 entrenamientos completados.</p>
             ...
             <div className="relative z-0 -mt-10 mx-auto w-[90%] bg-[#0F0F0F] border border-white/5 p-6 rounded-b-3xl opacity-80 scale-95">
                <div className="flex gap-4 items-center pl-4">
                     ...
                     <span className="text-gray-400 text-sm">Objetivo Semanal: 4/5 Sesiones</span>
                </div>
             </div>
