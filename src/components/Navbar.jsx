            ...
            <div className="mx-auto flex max-w-7xl items-center justify-between">
                ...
                {user ? (
                    <div className="flex items-center gap-4">
                        <Link to="/profile" className="relative flex items-center justify-center w-10 h-10 rounded-full overflow-hidden bg-zinc-800 text-green-500 hover:bg-zinc-700 hover:text-green-400 transition-all border border-zinc-700 shadow-md group" title="Tu Perfil">
